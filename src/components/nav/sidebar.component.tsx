  ...
  return (
    <>
      ...
      <div className="mobileShowSideBar">
        <button
          className="btn m-3 position-relative"
          type="button"
        ...
        <div
          className="offcanvas offcanvas-start bgBodySideBar"
          data-bs-scroll="true"
        ...
        >
          ...
          <div className="offcanvas-body bgHeaderSideBar p-0">
            <div className="row text-start m-4">
              ...
              <div className='col-12'>
                  <h4 className='mt-2 mb-0'>{user?.firstname}{' '}{user?.lastname}</h4>
                  <small>Autor</small>
              </div>
                ...
                <div className="row text-start m-4 ">
                    ...
                    <ul className='nav nav-pills flex-row align-items-start   '>
                      ...
                      >
                        ...
                        >
                          cottage
                        </span><span className='p-4 '>Home</span>
                      </a>
                      ...
                      >
                        ...
                        >
                          book_2
                        </span><span className='p-4'>Criar História</span>
                      </a></li>
                      <li className='mb-3'> <a
                        href="#"
                        className="nav-link text-white"
                      ...
                      >
                        ...
                        >
                          shelves
                        </span><span className='p-4'>Minhas Histórias</span>
                      </a></li>
                      <li><a
                        href="#"
                        className="nav-link text-white"
                      ...
                      >
                        ...
                        >
                          paid
                        </span><span className='p-4'>Ver Planos</span>
                      </a></li>
                      <li> </li>
                    </ul>
                    <div className='sair p-4' >
                        <a
                            href="#"
                            className="nav-link text-white"
                            onClick={() => logout()}
                          >
                              <span
                                  ...
                                  >
                                    logout
                                  </span><span className='p-4'>Sair</span>
