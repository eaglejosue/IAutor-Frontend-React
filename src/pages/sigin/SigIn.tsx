      ...
      <section className='container'>
        <div className='row justify-content-center'>
          ...
          >
            ...
            <div className='my-4'>
              <p className='f-14'>
                Inscreva-se para contar sua história!
              </p>
            </div>

            <div className='d-flex w-100 justify-content-center align-items-center mt-3'>
                <button className='btn btn-outline-primary rounded-5 f-14 px-4 py-2 f-14 w-80'
                type='button'
                onClick={() => googleLogin()}
                disabled={isLoading}
              >
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='row'>
                <div className='col-12 col-lg-6'>
                  <CustomInput
                    ...
                    name='password'
                    setValue={setValue}
                    passBtnLeft={isExtraLargeScreen ? '83%' : isLargeScreen ? '70%' : '83%'}
                    divClassName='col-12 mt-3'
                    validationSchema={{
              ...
              <div className='d-flex w-100 align-items-left mt-4'>
                <label className='text-muted f-12' style={{ textAlign: 'start' }}>
                  ...
                  />
                  Li e concordo com os<a href="">Termos e Condições</a>da plataforma
                </label>
              </div>

              <div className='d-flex mr-1 mt-1'>
                {errorMessage && <span className="text-danger f-12">{errorMessage}</span>}
              </div>
              ...
              <div className='d-flex w-100 justify-content-center align-items-center mt-2'>
                <button className='btn btn-secondary text-white rounded-5 f-14 px-4 py-2 f-14 w-80'
                  type='submit'
                  disabled={isLoading}
                >
                  Criar Conta
              ...
              <div className='d-flex w-100 justify-content-center align-items-center mt-2'>
                <button className='btn btn-primary rounded-5 f-14 px-4 py-2 f-14 w-80'
                  type='button'
                  disabled={isLoading}
