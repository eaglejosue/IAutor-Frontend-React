          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-md-4 f-18">
              <div className="d-flex align-items-center">
                <div className="fw-bold">Criar História /</div>
                <div
                  className="d-flex bg-primary align-items-center justify-content-center mx-2"
                  style={{
                    width: "16px",
                    height: "16px",
                    borderRadius: "100%",
            ...
            <div className="col-md-5">
              <div className="row align-items-center justify-content-end">
                <div className="col-auto">
                  <div
                    className="btn btn-outline-secondary disabled rounded-5 f-12 px-4 py-2"
                    style={{ fontWeight: "bold" }}
                  >
                ...
                <div className="col-auto">
                  <a
                    className="btn bg-secondary text-white rounded-5 f-12 px-4 py-2"
                    style={{ fontWeight: "bold" }}
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <span
                                  className="material-symbols-outlined"
                                  style={{ fontSize: "16px", color: "#DB3737" }}
                                >
                                  edit
                                </span>
                              </div>
          ...
          <Modal.Body className="text-center justify-content-center pt-0 px-5">
            ...
            {termsTextModal === 1 && (
              <>
                ...
                <div className="border-bottom f-15 pt-2 pb-3">
                  Bem vindo Autor, você dará inicio à criação de sua história.
                  No livro degustação você poderá experimentar a criação de um
                  livro de memórias usando os recursos da plataforma{" "}
                  <b>IAutor</b>.
                </div>
            ...
            {termsTextModal === 2 && (
              <>
                ...
                <div className="border-bottom f-15 pt-2 pb-3">
                  Responda as perguntas com sinceridade e o máximo de detalhes
                  possíveis. Ao mesmo tempo, evite compartilhar informações
                  íntimas ou sensíveis.
                </div>
                <div className="d-flex justify-content-center pt-3">
                  <div
                    className="btn bg-secondary text-white rounded-5 f-12 py-2 w-60"
        ...
        >
          ...
          >
            ...
            <div className="pt-3">
              ...
              ressaltando que mais informações tornam o conteúdo mais valioso.
            </div>
            <div className="pt-3">
            ...
            <div className="pt-3">
              Após finalizar o texto, escolha uma característica que resuma a
              resposta (como humor ou romantismo) antes do envio para a
              Inteligência artificial do <b>IAutor</b>.
            </div>
            <div className="pt-3">
