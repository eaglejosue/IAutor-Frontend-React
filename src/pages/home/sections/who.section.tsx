...
const SectionWho =() =>{
    ...
    return (
      <>
        <div className="row align-items-center text-justify mt-5 mb-5 desktopShow">
          <div className="col-6  ">
            <div className="row">
        ...
        <div className="row align-items-center text-justify mt-5 mb-5 mobileShow">
        <div className="col-sm-12 text-end  p-0">
            <img
              alt="Pai e filho"
              className="img-fluid"
