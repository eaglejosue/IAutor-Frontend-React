  ...
  return (
    <div className="mb-5">
      ...
      <p className="mt-3 mb-5">
        Descubra a flexibilidade e benefícios das nossas ofertas de pacotes para
        <br></br> atender suas necessidades especificas
      </p>
                ...
                <div className="card-body text-start">
                  ...
                  <div className="row text-center">
                    <div className="d-flex border-top justify-content-center pt-3">
                      <div
                        className={`btn ${i == 1 ? "bg-white text-black" : "bg-secondary text-white"} rounded-5 f-13 py-3 mb-4 w-70`}
                        style={{
                          fontWeight: "bold",
                          position: "absolute",
                          bottom: "0px",
                        ...
                        onClick={() => {
                          plan.price === 0
                            ...
                            : navigate(
                                `${paths.LOGIN}?redirect=${paths.PAYMENT_TERMS}/${plan.id}`,
                              );
                        }}
                      >
                        Experimentar agora
