...
const Home = lazy(() => import('../pages/home/hhome'));
const Login = lazy(() => import('../pages/login/llogin'));
const SigIn = lazy(() => import('../pages/sigin/ssigin'));
...
const Terms = lazy(() => import("../pages/admin/terms/tterms"));
const Users = lazy(() => import("../pages/admin/users/uusers"));
